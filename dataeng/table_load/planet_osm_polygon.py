...
flist = listdir("/Users/rzwitch/planet_osm_polygon")
for f in flist:
  conn.cursor().execute(f"PUT file:///Users/rzwitch/planet_osm_polygon/{f} @%planet_osm_polygon")
  print(f + " loaded successfully")

conn.cursor().execute("""COPY INTO planet_osm_polygon
